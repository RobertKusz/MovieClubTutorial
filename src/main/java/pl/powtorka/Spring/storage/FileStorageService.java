package pl.powtorka.Spring.storage;
...
public class FileStorageService {
    ...
    private String saveFile(MultipartFile file, String storageLocation) {
        Path filePath = createFileStream(file, storageLocation);
        try{
    ...
    private Path createFileStream(MultipartFile file, String storageLocation) {
